...
def Decision(Round, n, ki, kd,MatsuiRoundIndex, MatsuiCount, flag):
    ...
    for r in range(0, Round):
        ...
        for i in range(0,HalfBlockSize):
            GenEqual(k2[r][i],k0[r+1][i],file)
            GenEqual(k3[r][i], k1[r + 1][i], file)
        ...
        GenXORC(ko0[r],K1out,r,2*HalfBlockSize,1,file)
    ...
    clauseseq = ""
    for i in range(0, HalfBlockSize):
        clauseseq += str(x0[0][i] + 1) + " " + str(x1[0][i] + 1)+ " " + str(x2[0][i] + 1)+ " " + str(x3[0][i] + 1) + " "+ str(k0[0][i] + 1) + " "+ str(k1[0][i] + 1) + " "+ str(k2[0][i] + 1) + " "+ str(k3[0][i] + 1) + " "
    clauseseq += "0" + "\n"
